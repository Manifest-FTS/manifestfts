...
History</span> In New York City.</h1>
                ...
                <section className="section-box" id="continue">
                    <div className="container mt-90">
                        ...
                        <p className="text-body-lead-large color-gray-600 mt-10">Our collaboration with Barclay Rex allowed us to use the power of <span className="color-violet-600 font-bold">Strapi</span>, an open-source headless CMS. This became the heart of Barclay Rex's content management system, enabling them to swiftly make edits and manage their content with ease and precision. Strapi ensured information was secure yet accessible, revolutionizing their ability to manage website copy changes.</p>
                        ...
                        <p className="text-body-lead-large color-gray-600 mt-30">Overall, our technological stack was a meticulously chosen assortment of powerful tools, each playing a crucial role in transforming Barclay Rex's digital presence and eCommerce capabilities.
                        </p>
                    </div>
                </section>
