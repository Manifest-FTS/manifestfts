                    ...
                    <div className="container mt-120">
                        <div className="row">
                            ...
                            <div className="col-lg-6 col-sm-12 block-we-do">
                                ...
                                <Link href="https://flyozone.com/" target="_blank"><a className="btn icon-arrow-right color-gray-900 text-body-lead mb-15 mt-30 pl-0 pr-12 py-3">Visit Website</a></Link>
                                <div className="row">
                                    <div className="col-12 mt-50">
                                        <h2 className="text-heading-7 text-center color-gray-900 mb-10">Powered by</h2>
                                        <ul className="list-partners border-0">
