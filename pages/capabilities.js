...
const capabilityCards = [
  {
    ...
    copy: 'From marketing sites to more involved product work, Manifest FTS supports planning, design, implementation, iteration, and ongoing improvement.',
  },
  {
    tag: 'Design & UX',
    title: 'Interface design, UX refinement, and conversion support',
    copy: 'We help shape clearer user journeys, stronger interfaces, and more cohesive experiences without separating strategy from execution.',
  },
  {
    tag: 'Ongoing Support',
    title: 'Enhancements, maintenance, SEO implementation, and technical guidance',
    copy: 'The retainer is designed for the real mix of digital work that builds up over time: improvements, fixes, implementation, support, and momentum.',
  },
];
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-8">
                <span className="tag-1 bg-5 color-green-900 mr-20 px-4 py-2 rounded-md">
                  Capabilities + Retainer
                </span>

                <h1 className="text-display-3 mt-30">
                  Ongoing support for design, development, strategy, and digital execution.
                </h1>

                <p className="text-body-lead-large color-gray-600 mt-30 pr-40">
                  Manifest FTS supports a broad range of digital work through one ongoing model —
                  websites, applications, UX/UI, implementation, enhancements, maintenance, and
                  growth-oriented support.
                </p>

                <div className="mt-40">
                  <RetainerTrigger
                    className="btn btn-black icon-arrow-right-white mr-20 mb-15"
                    source="capabilities_hero"
                    hours={hours}
                  >
                    Start a Retainer
                  </RetainerTrigger>
                  ...
                  <Link href="/work">
                    <a className="btn btn-link text-heading-6 mb-15">See Our Work</a>
                  </Link>
                </div>
              </div>
            </div>
              ...
              return (
                <div className="col-lg-4 col-sm-12" key={card.title}>
                  <div className="bg-2 box-square hover-up" style={{ height: '100%', paddingBottom: 40 }}>
                    ...
                    <p className="text-body-text-md color-gray-600 mb-0">{card.copy}</p>
                  </div>
                </div>
              );
            })}
          ...
          <div className="row align-items-center">
            <div className="col-lg-5 mb-40">
              ...
              <h2 className="text-heading-1 mt-30">
                A flexible monthly structure with room to evolve.
              </h2>

              <p className="text-body-lead-large color-gray-600 mt-30">
                Choose a monthly commitment, use those hours where they matter most, and adjust the
                relationship as priorities change.
              </p>

              <p className="text-body-text color-gray-600 mt-20 mb-0">
                The goal is simple: one consistent partnership model for the digital work that does
                not fit neatly into a one-time project.
              </p>
            </div>
            ...
            <div className="col-lg-7">
              <RetainerBuilder
                ...
                title="Choose your monthly rhythm"
                subtitle="Select a commitment that matches the level of support you need right now."
              />

              <div className="mt-30">
                <RetainerTrigger
                  className="btn btn-black icon-arrow-right-white"
                  source="capabilities_builder"
                  hours={hours}
                >
          ...
          <div className="row">
            <div className="col-lg-5 mb-40">
              ...
              <p className="text-body-text color-gray-600 mt-30">
                A few practical notes on what the retainer covers and how the model works.
              </p>
            </div>
