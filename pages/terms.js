                                ...
                                <div className="row">
                                    <div className="col-lg-2">
                                        <div className="table-of-content">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <Link href="#section-7a"><a>Refund Policy</a></Link>
                                                </li>
                                                <li>
                                                    <Link href="#section-7b"><a>Late Fees & Suspension</a></Link>
                                                </li>
                                                <li>
                                    ...
                                    <div className="col-lg-8">
                                        <div className="single-detail">
                                            ...
                                            <h6 className="mt-35 mb-25" id="section-7a">Price Changes</h6>
                                            ...
                                            <h6 className="mt-35 mb-25" id="section-7b">Late Fees & Suspension</h6>
