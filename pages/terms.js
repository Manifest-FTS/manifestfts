                ...
                <div className="row">
                  <div className="col-lg-2">
                    <div className="table-of-content">
                      <h6 className="mb-15">Table of contents</h6>
                      <ul>
                        <li>
                          <Link href="#section-0"><a>Customer Data</a></Link>
                        </li>
                        <li>
                          <Link href="#section-1"><a>License</a></Link>
                        </li>
                        <li>
                          <Link href="#section-2"><a>Limitation of Liability</a></Link>
                        </li>
                        <li>
                          <Link href="#section-3"><a>Delivery & Ownership</a></Link>
                        </li>
                        <li>
                          <Link href="#section-4"><a>Updates</a></Link>
                        </li>
                        <li>
                          <Link href="#section-5"><a>Help & Support</a></Link>
                        </li>
                        <li>
                          <Link href="#section-6"><a>Price Changes</a></Link>
                        </li>
                        <li>
                          <Link href="#section-7"><a>Refund Policy</a></Link>
                        </li>
                        <li>
                          <Link href="#section-8"><a>Late Fees & Suspension</a></Link>
                        </li>
                        <li>
                          <Link href="#section-9"><a>Email &amp; Newsletter</a></Link>
                        </li>
                        <li>
                          <Link href="#section-10"><a>Mobile Apps</a></Link>
                        </li>
                        <li>
                          <Link href="#section-11"><a>License Agreement</a></Link>
                        </li>
                        <li>
                          <Link href="#section-12"><a>Severability</a></Link>
                        </li>
                        <li><strong>Promotions</strong></li>
                        <li>
                          <Link href="#section-13"><a className="truncate">WordPress Hosting & Mgmt</a></Link>
                        </li>
                        <li>
                          <Link href="#section-13"><a>Free Website Promo</a></Link>
                        </li>
                      </ul>
                    </div>
                  </div>
                  <div className="col-lg-8">
                    <div className="single-detail">
                      ...
                      <h6 className="mt-35 mb-25" id="section-9">Late Fees & Suspension</h6>
                      <p>Invoices are due according to the payment terms listed on the invoice or service agreement. Any unpaid balance remaining fifteen (15) days after the invoice due date may incur a late fee of up to 1.5% per month on the outstanding balance.
                      </p>
                      <p>Manifest FTS reserves the right to pause non-critical support, development work, maintenance, updates, or consulting services for accounts with overdue balances.
                      </p>
                      <p>Hosting, maintenance, or other recurring services may be suspended after forty-five (45) days of non-payment. Manifest FTS will make reasonable efforts to provide notice prior to suspension whenever possible.
                      </p>
                      <p>Manifest FTS shall not be liable for damages, losses, downtime, business interruption, or data issues resulting from suspension or termination of services related to non-payment.
                      </p>
                      <p>Accounts sent to collections or requiring legal recovery efforts may be responsible for additional administrative, legal, or collection-related costs where permitted by law.
                      </p>
                      
                      <h6 className="mt-35 mb-25" id="section-10">Email &amp; Newsletter</h6>
                      ...
                      <h6 className="mt-35 mb-25" id="section-11">Mobile Apps</h6>
                      ...
                      <h6 className="mt-35 mb-25" id="section-13">WordPress Hosting & Management Terms</h6>
                      ...
                      <ul>
                        <li>
                          <strong>Hosting Plans:</strong> Each plan includes specific features and limitations. Starter includes 1 WordPress install, 25,000 monthly visits, 10GB storage, and 50GB bandwidth. Growth and Enterprise plans increase limits and add features such as performance insights, quarterly security reviews, and DevOps support. Full plan details are listed on our hosting page.
                        </li>
                        <li>
                          <strong>Plan Scope:</strong> All plans include quarterly WordPress maintenance. Additional support, development work, or performance tuning may be billed separately unless covered under a promotional offer or retainer agreement.
                        </li>
                        <li>
                          <strong>Access & Control:</strong> Clients have access to the WordPress admin dashboard, but do not receive root, cPanel, or database credentials. Platform infrastructure is fully managed and optimized by Manifest to ensure security and stability.
                        </li>
                        <li>
                          <strong>Backups & Uptime:</strong> We provide daily backups and make reasonable efforts to ensure uptime and security. However, we do not guarantee 100% uptime and are not liable for third-party outages, plugin failures, or customer-introduced errors.
                        </li>
                        <li>
                          <strong>Migration:</strong> If migrating from another host, Manifest will assist with one-time migration of WordPress files and database. The client is responsible for DNS access and third-party service coordination (e.g., email, CDN).
                        </li>
                        <li>
                          <strong>Performance Optimization:</strong> Our team monitors site performance and may recommend or apply server-side caching, image optimization, and code cleanup as part of Growth or Enterprise plans.
                        </li>
                        <li>
                      ...
                      <h6 className="mt-35 mb-25" id="section-14">Free Website Promotion Terms</h6>
                      ...
                      <ul>
                        <li>
                          Websites are built using pre-designed templates provided by ManifestFTS, and include up to five standard pages. Clients must choose from the available templates; design changes are not permitted except for minor visual adjustments (such as logo, colors, or small layout tweaks).
                        </li>
                        <li>
                          <strong>Access</strong> to the codebase, FTP or hosting control panel is not provided. However, limited WordPress admin access may be granted solely for posting and managing blog content.
                        </li>
                        <li>
                          <strong>Website delivery</strong> is included with your subscription. Upon signup, your website will be setup and launched within 45-60 business days, depending on prompt content submission and feedback. There are no setup or design fees — this service is included as part of your active subscription.
                        </li>
                        <li>
                          This promotion does not include advanced development, third-party integrations, or non-scope custom requests unless agreed upon separately in an Advanced plan.
                        </li>
                        <li>Refunds will not be issued for setup, partial months, or ongoing subscriptions once the website has been published. Canceling the subscription stops future billing but does not entitle the customer to any refund.</li>
                        <li>Manifest FTS reserves the right to suspend or terminate service for violations of these terms, misuse of the platform, abusive behavior, or failure to pay.</li>
                      </ul>
                    </div>
                  </div>
                </div>
